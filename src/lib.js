...
function findCardDb(explicit) {
  ...
  if (!dir) throw new Error("MTGA-Installationsordner nicht gefunden. Bitte --db <Pfad zu Raw_CardDatabase_*.mtga> angeben.");
  const raw = path.join(dir, "MTGA_Data", "Downloads", "Raw");
